...
def run_transformer_block(
    ...
    trasformer_block = TransformerBlock(d_model, num_heads, d_ff, max_seq_len, theta, device=in_features.device, dtype=in_features.dtype)
    trasformer_block.load_state_dict(weights)
    return trasformer_block(in_features)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.optim import clip_gradient_norm
